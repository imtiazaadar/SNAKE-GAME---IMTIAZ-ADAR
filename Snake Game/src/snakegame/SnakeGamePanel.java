...
public class SnakeGamePanel extends JPanel implements ActionListener{
	...
	private int score = 0, delay = 160, body_parts = 5, appleX, appleY;
	...
	public void draw(Graphics g) {
		if(running) {
			...
			g.drawString("SNAKE GAME BY IMTIAZ ADAR", 930, 54);
	...
	public void ScoreSet(Graphics g) {
		...
		FontMetrics font = getFontMetrics(g.getFont());
		g.drawString("SCORE : " + score, (width - font.stringWidth("SCORE : " + score)) / 2, 64);
	}
	public void GameOver(Graphics g) {
		...
		if(!running) {
			...
			resetGame.setBounds(474, 600, 350, 70);
